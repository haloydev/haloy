...
func (s *APIServer) setupRoutes() {
	...
	s.router.Handle("POST /v1/images/layers/check", httpWithAuth(s.handleLayerCheck()))
	s.router.Handle("POST /v1/images/layers", httpWithAuth(s.handleLayerUpload()))
	s.router.Handle("POST /v1/images/layers/assemble", httpWithAuth(s.handleImageAssemble()))
